    ...
    return (
        <section id="features" className="py-20 2xl:py-32">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <Title
                    title="Features"
                    heading="Everything you need to create high-impact thumbnails"
                    description="AI-powered tools designed to help creators, marketers, and teams generate click-worthy thumbnails in seconds."
                />
